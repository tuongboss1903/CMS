...
<form method="POST" action="/admin/products/<?= $this->e((string) $product['id']) ?>">
    ...
    <div class="field">
        <label for="stock_quantity">Ton kho</label>
    ...
    <div class="field">
        ...
        <select id="status" name="status">
            <option value="draft" <?= ($old['status'] ?? 'draft') === 'draft' ? 'selected' : '' ?>>Nhap</option>
            <option value="published" <?= ($old['status'] ?? '') === 'published' ? 'selected' : '' ?>>Da xuat ban</option>
        </select>
    </div>
