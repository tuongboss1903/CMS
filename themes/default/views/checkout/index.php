...
<div class="commerce-layout">
    <form method="POST" action="/checkout">
        ...
        <h2 style="margin-top:0;">Thong tin giao hang</h2>
        <div class="field">
        ...
        <div class="card">
        <h2 style="margin-top:0;">Phuong thuc thanh toan</h2>
        ...
        <?php endif; ?>
        <button type="submit" class="btn btn-primary btn-block" style="margin-top: var(--space-5);">Xac nhan dat hang</button>
    </form>
    ...
    <aside class="order-summary">
        ...
        <div class="order-summary-row">
            ...
            <span><?= $this->e(\number_format(((float) $item['price']) * ((int) $item['quantity']), 0, ',', '.')) ?> d</span>
        </div>
        <?php endforeach; ?>
